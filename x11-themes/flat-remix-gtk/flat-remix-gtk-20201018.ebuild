...
DESCRIPTION="Flat Remix GTK theme is a pretty simple gtk window theme inspired on material design following a modern design using \"flat\" colors with high contrasts and sharp borders."
...
# Portage.
SRC_URI="https://github.com/daniruiz/${PN}/archive/${PV}.tar.gz"
...
src_install() {
	...
	use blue   && doins -r Flat-Remix-GTK-Blue*
	use green  && doins -r Flat-Remix-GTK-Green*
	use red    && doins -r Flat-Remix-GTK-Red*
	use yellow && doins -r Flat-Remix-GTK-Yellow*
}
