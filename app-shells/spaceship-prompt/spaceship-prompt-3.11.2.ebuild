...
# Portage.
SRC_URI="https://github.com/denysdovhan/spaceship-prompt/archive/v${PV}.tar.gz"
...
# Te following src_install function is implemented as default by portage, so
...
src_install() {
	...
	dodir "/usr/share/zsh/5.8/functions/Prompts"
	insinto "/usr/lib/spaceship-prompt"
	doins -r "spaceship.zsh"
	ln -s ${PORTAGE_BUILDDIR}/image/usr/lib/spaceship-prompt/spaceship.zsh ${PORTAGE_BUILDDIR}/image/usr/lib/spaceship-prompt/spaceship.zsh.theme
	cp -r ${WORKDIR}/${P}/lib ${PORTAGE_BUILDDIR}/image/usr/lib/spaceship-prompt
	cp -r ${WORKDIR}/${P}/scripts ${PORTAGE_BUILDDIR}/image/usr/lib/spaceship-prompt
	cp -r ${WORKDIR}/${P}/sections ${PORTAGE_BUILDDIR}/image/usr/lib/spaceship-prompt
	ln -s /usr/lib/spaceship-prompt/spaceship.zsh ${PORTAGE_BUILDDIR}/image/usr/share/zsh/5.8/functions/Prompts/prompt_spaceship_setup
	dodoc "README.md"
}
